                ...
                <>
                    <ScrollView style={styles.mainScreen}>
                        <View style={styles.questionStyle}>
                            <AntDesign name="questioncircleo" size={24} color="#FFBE98" />
                        </View>
                        <View style={styles.titleContainer}>
                            <Text style={styles.nameTitle}>Nguyen Văn A</Text>
                            <Pressable onPress={() => { setSetting(!isSetting) }}>
                                <MaterialIcons name="settings" size={24} color="#FFBE98" />
                            </Pressable>
                        </View>
                        {/* Function 1 */}
                        ...
                        <Pressable style={styles.functionContainerStyle}>
                            <View style={styles.functionPressable}>
                                <FontAwesome6 name="box-open" size={24} color="black" style={styles.functionIcon} />
                                <Text style={styles.functionDescription}>Cập nhật sản phẩm</Text>
                            </View>
                            <AntDesign name="caretright" size={15} color="black" />
                        </Pressable>
                        {/* Function 3 */}
                        <Pressable style={styles.functionContainerStyle}>
                            <View style={styles.functionPressable}>
                                <MaterialIcons name="logout" size={25} color="black" style={[styles.functionIcon, { marginLeft: 5 }]} />
                                <Text style={styles.functionDescription}>Đăng xuất</Text>
                            </View>
                            <AntDesign name="caretright" size={15} color="black" />
                        </Pressable>
                    </ScrollView>
            ...
            <View style={styles.contentContainer}>
                <View style={[styles.content, styles.contentBox]}>
                    <View style={styles.headerPoint}>
                        <Pressable onPress={() => { setSetting(!isSetting) }} >
                            <AntDesign name="closecircleo" size={24} color="#FFBE98" />
                        </Pressable>
                    </View>
